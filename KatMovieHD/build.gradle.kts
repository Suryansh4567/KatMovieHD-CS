...
cloudstream {
    ...
    description = "Hindi dubbed & dual-audio movies / TV series from KatMovieHD. v29: fixes MoviesBaba content container selection, Bollywood listings, and Hindi web-series episode links."
    language    = "hi"
