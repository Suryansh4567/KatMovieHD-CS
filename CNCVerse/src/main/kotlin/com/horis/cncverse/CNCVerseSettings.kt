...
class CNCVerseSettings(
    ...
    private fun getDrawable(name: String): Drawable? {
        val id = plugin.resources?.getIdentifier(name, "drawable", "com.horis.cncverse")
    ...
    private fun getString(name: String): String? {
        val id = plugin.resources?.getIdentifier(name, "string", "com.horis.cncverse")
    ...
    private fun <T : View> View.findViewByName(name: String): T? {
        val id = plugin.resources?.getIdentifier(name, "id", "com.horis.cncverse")
    ...
    override fun onCreateView(
        ...
        val layoutId = plugin.resources?.getIdentifier("settings", "layout", "com.horis.cncverse")
        return layoutId?.let {
